...
void AC_AttitudeControl::landing_controller_setRVT( bool rvt_active, bool rvt_countertorque_active, int rvt_pwm )
{
    _motors.set_reverse_thrust(rvt_active, rvt_countertorque_active, rvt_pwm);
}

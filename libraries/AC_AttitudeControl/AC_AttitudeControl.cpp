...
void AC_AttitudeControl::landing_controller_setRVT( bool is_reverse_thrust_active, int rvt_pwm )
{
    _motors.set_reverse_thrust(is_reverse_thrust_active, rvt_pwm);
}

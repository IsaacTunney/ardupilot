...
public:
    ...
    void                set_reverse_thrust(bool activate_rvt, uint16_t rvt_pwm) { _activate_rvt = activate_rvt; _rvt_pwm = rvt_pwm; };     // REVERSE THRUST ADDED (CUSTOM FUNCTION)
...
protected:
    ...
    */
    ...
    bool                _activate_rvt;              // Activated reverse thrust - MODE CUSTOM
    uint16_t            _rvt_pwm;                   // PWM sent to motors during custom landing sequence

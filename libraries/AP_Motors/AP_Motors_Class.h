...
public:
    ...
    void                set_reverse_thrust(bool activate_rvt, bool activate_rvt_ct, uint16_t rvt_pwm) { _activate_rvt = activate_rvt;  _activate_rvt_ct = activate_rvt_ct; _rvt_pwm = rvt_pwm; };     // REVERSE THRUST ADDED (CUSTOM FUNCTION)
